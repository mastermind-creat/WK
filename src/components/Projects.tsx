        ...
        <section id="projects" className="section-padding relative overflow-hidden" style={{ backgroundColor: 'var(--bg-main)' }}>
            ...
            <div className="container-custom relative z-10">
                    ...
                    <div className="md:hidden overflow-x-auto pb-6 -mx-4 px-4 snap-x snap-mandatory scrollbar-hide">
                        <div className="flex gap-4 w-max">
                            {projects.slice(0, 6).map((project, idx) => (
                                <div key={project.title} className="w-[260px] snap-start">
                ...
                >
                    <motion.a
                        href="/projects"
                        className="inline-flex items-center gap-2 px-6 md:px-8 py-3.5 md:py-4 glass rounded-xl md:rounded-2xl font-bold text-[10px] md:text-sm uppercase tracking-wider hover:border-primary-500/50 transition-all"
        ...
        >
            ...
            >
                ...
                <div className="p-4 md:p-6" style={{ transform: 'translateZ(20px)' }}>
                    <h3 className="text-[13px] md:text-xl font-black mb-1.5 md:mb-3 group-hover:text-primary-500 transition-colors" style={{ color: 'var(--text-main)' }}>
                        {project.title}
                    </h3>

                    <p className="text-[10px] md:text-sm leading-relaxed mb-2.5 md:mb-4 line-clamp-2" style={{ color: 'var(--text-muted)' }}>
                        {project.description}
                    </p>

                    {/* Tech Stack */}
                    <div className="flex flex-wrap gap-1 md:gap-2 mb-3 md:mb-0">
                        {project.tags.slice(0, 3).map((tag: string) => (
                            <span
                                key={tag}
                                className="text-[8px] md:text-xs px-2 md:px-3 py-0.5 md:py-1 rounded-full font-bold"
                                style={{
